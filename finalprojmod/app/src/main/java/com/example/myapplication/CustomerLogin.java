...
public class CustomerLogin extends AppCompatActivity {
    ...
    @ViewById(R.id.customerLoginRegisterLink)
    TextView customerLoginRegisterL;

    @ViewById(R.id.customerLoginBackLink)
    TextView customerLoginCancelL;


    @AfterViews
    public void init(){
        getWindow().getDecorView().setBackgroundColor(Color.WHITE);
        customerLoginCancelL.setPaintFlags(customerLoginCancelL.getPaintFlags() | Paint.UNDERLINE_TEXT_FLAG);
        customerLoginRegisterL.setPaintFlags(customerLoginRegisterL.getPaintFlags() | Paint.UNDERLINE_TEXT_FLAG);
