...
public class CustomerShopsSpecificProduct extends AppCompatActivity {
    ...
    @ViewById (R.id.product_back2)
    TextView productBack2L;

    @AfterViews
    public void init(){
        getWindow().getDecorView().setBackgroundColor(Color.WHITE);
        productBack2L.setPaintFlags(productBack2L.getPaintFlags() | Paint.UNDERLINE_TEXT_FLAG);
