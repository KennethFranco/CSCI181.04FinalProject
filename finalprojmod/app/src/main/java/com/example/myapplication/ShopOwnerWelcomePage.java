...
public class ShopOwnerWelcomePage extends AppCompatActivity {
    ...
    TextView shopLoginRegisterL;

    @ViewById(R.id.shopLoginBackLink)
    TextView shopLoginBackL;

    @AfterViews
    public void init() {
        getWindow().getDecorView().setBackgroundColor(Color.WHITE);
        shopLoginBackL.setPaintFlags(shopLoginBackL.getPaintFlags() | Paint.UNDERLINE_TEXT_FLAG);
        shopLoginRegisterL.setPaintFlags(shopLoginRegisterL.getPaintFlags() | Paint.UNDERLINE_TEXT_FLAG);
