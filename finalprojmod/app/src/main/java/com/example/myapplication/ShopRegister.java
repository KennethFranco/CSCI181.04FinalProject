...
public class ShopRegister extends AppCompatActivity {
    ...
    @ViewById(R.id.shopRegisterLoginLink)
    TextView shopRegisterLoginL;

    @ViewById(R.id.shopRegisterBackLink)
    TextView shopRegisterBackL;


    @AfterViews
    public void init() {
        getWindow().getDecorView().setBackgroundColor(Color.WHITE);
        shopRegisterBackL.setPaintFlags(shopRegisterBackL.getPaintFlags() | Paint.UNDERLINE_TEXT_FLAG);
        shopRegisterLoginL.setPaintFlags(shopRegisterLoginL.getPaintFlags() | Paint.UNDERLINE_TEXT_FLAG);
